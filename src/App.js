...
const steps=[
      ...
      {
        id: 'tts',
        component: <a href="https://humanizerbot.herokuapp.com/texttospeech.html" target="_blank" rel="noreferrer" class="w3-button w3-blue w3-hover-blue">Go to the page<br/>(Click here)</a>,
        asMessage: true,
        trigger: 'continue',
      },
      {
